...
NOTE: Check Blackboard for a link to most of these papers. I've put them all into a Zotero repository (.rdf file). If you have not already done so, download [Zotero](https://www.zotero.org). Then, download the .rdf file from blackboard and load it from Zotero. All of the .pdfs should now appear in a new Zotero folder.
